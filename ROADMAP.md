...
- [x] Public search can match Bundle ID and parsed package metadata
...
- [x] Contract tests for metadata search/status/iOS version comparison
- [ ] Current-head GitHub Actions green for 2026091221
